...
const COMENTARIOS: { [dia: number]: string } = {
  ...
  9: `La devoción a la medalla y a la cruz de San Benito comenzó a difundirse hace unos trescientos años. La unión de la imagen de la cruz con la del santo en la medalla es una manera de recordar todos los milagros narrados en su vida y de pedir la misma ayuda divina por medio de su intercesión. La medalla no es un objeto mágico ni un amuleto, sino un objeto religioso, una imagen sagrada cristiana, que adquiere todo su significado y su eficacia en consonancia con lo que la Iglesia enseña sobre las imágenes y los signos religiosos.`,
  34: `Si es que aún no lo hemos hecho, no dejemos pasar los días de esta cuaresma sin confesarnos. Dios derrama abundantes gracias en el sacramento de la confesión. Nos preparamos con verdadera devoción y dolor de nuestros pecados, para transitar purificados esta cuaresma.`,
  40: `La Providencia ha querido que hoy, en el día de San Gregorio Papa, autor de la vida de San Benito que leímos durante Septuagésima, inicie justamente la novena al Patriarca de Occidente. Hoy hasta el día 20 de marzo, rezaremos adicionalmente una novena a nuestro patrono pidiendo que nos ayude a vivir con verdadero espíritu benedictino este itinerario.`,
  ...
  57: `Los más grandes misterios de nuestra Redención, es decir la PASIÓN, la MUERTE y la RESURRECCIÓN de Nuestro Señor Jesucristo, fueron celebrados por la Santa Madre Iglesia desde la época apostólica, todos los años con singular recordación. Es, pues, ésta una semana de santas e íntimas emociones, muy apropiadas para afianzar nuestra fe y para la conversión de los pecadores. Una buena y reformadora Confesión, con una fervorosa Comunión, será el fruto inmediato más precioso de esta semana de salvación.`,
  64: `¡FELIZ Y SANTA PASCUA DE RESURRECCIÓN!`,
  65: `Ayer concluyó el itinerario que iniciamos hace 65 días. Hemos recorrido de la mano del Patriarca San Benito y la Liturgia estos días. Tratemos de perseverar en este camino que realmente concluye en el Cielo. San Benito, ¡ora pro nobis!`,
};
